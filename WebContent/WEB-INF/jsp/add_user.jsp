...
<form:form commandName="policy" action="addUser.html">
<fieldset>
<legend>人员信息录入</legend>
	<label for="firstname" accesskey="f">姓名: </label>
		<form:input path="name" type="text" tabindex="1" value="" title="first name"/><br>
	<label for="lastname" accesskey="l">所属门店: </label>
		<form:input path="account" type="text" tabindex="2" title="last name"/><br>
