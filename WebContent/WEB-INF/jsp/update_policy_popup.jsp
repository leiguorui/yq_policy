				...
				<tbody>
					<tr>
						...
						<div class="input-append">
							<form:input path="type" class="span2" type="text"/>
					...
					<tr>
						...
						<td>
						<form:input path="loan_years" style="width:20px" type="text" /> 年
						</td>
					</tr>
					<tr>
						...
						<form:input path="from" id="id_from" style="width:80px" type="text" onClick="WdatePicker()"/> 至  
						<form:input path="to" id="id_to" style="width:80px" type="text" onClick="WdatePicker()"/> 共计 
						<form:input path="years" id="id_years" style="width:20px" type="text" /> 天
						</td>
					</tr>
					<tr>
						...
						<td>
						<div class="input-append">
							<form:input path="service" class="span2" type="text" />
							<div class="btn-group dropup">
								<button class="btn dropdown-toggle" data-toggle="dropdown">
									请选择 <span class="caret"></span>
								</button>
					...
					<tr>
						...
						<td>
						<div class="input-append">
							<form:input path="insuer_comp" class="span2" type="text" />
							<div class="btn-group dropup">
								<button class="btn dropdown-toggle" data-toggle="dropdown">
									请选择 <span class="caret"></span>
								</button>
					...
					<tr>
						...
						<td><form:input path="jiaoqiangxian_no" class="span2" type="text" /></td>
					</tr>
					<tr>
						<td class="center">商业险保单号</td>
						<td><form:input path="shangyexian_no" class="span2" type="text" /></td>
					</tr>
					<tr>
						...
						<div class="input-prepend">
							...
							<form:input path="jiaoqiangxian_sum" class="span6" type="text" placeholder="100,000,000" /> 
						</div>						
						</td>
					</tr>
					<tr>
						...
						<div class="input-prepend">
							<span class="add-on">&yen;</span>
							<form:input path="shangyexian_sum" class="span6" type="text" placeholder="100,000,000" /> 
						</div>	
						</td>
					</tr>
					<tr>
						...
						<td>
						<div class="input-append">
							<form:input path="jiao_discount" class="span6" type="text" placeholder="100,000,000" /> 
					...
					<tr>
						...
						<td>
						<div class="input-append">
							<form:input path="shang_discount" class="span6" type="text" placeholder="100,000,000" /> 
							<span class="add-on">.00</span>
						</div>					
						</td>
					</tr>
					<tr>
						...
						<td>
							<div class="input-prepend">
							<span class="add-on">&yen;</span>
							<form:input path="present_sum" class="span6" type="text" placeholder="100,000,000" /> 
							</div>	
						</td>
					</tr>
					<tr>
						...
						<td>
						<div class="input-append">
							<form:input path="channel" class="span2" type="text" />
							<div class="btn-group dropup">
								<button class="btn dropdown-toggle" data-toggle="dropdown">
									请选择 <span class="caret"></span>
								</button>
					...
					<tr>
						...
						<td><form:input path="note" class="span2" type="text" /></td>
					</tr>
				</tbody>
...
<form:input path="id" class="span6" type="hidden"/>
	<div class="widget">
				...
				<tbody>
					<tr>
						...
						<div class="input-prepend">
							...
							<form:input path="number" class="span6" type="text" placeholder="辽A10000" /> 
						</div>
						</td>
					</tr>
					<tr>
						...
						<div class="input-prepend">
							<span class="add-on">No.</span>
							<form:input path="vin" class="span6" type="text" placeholder="1000000" />
						</div>
						</td>
					</tr>
					<tr>
						...
						<div class="input-prepend">
							<span class="add-on">No.</span>
							<form:input path="engine_no" class="span6" type="text" placeholder="1000000" />
						</div>
						</td>
					</tr>
					<tr>
						...
						<div class="input-prepend">
							...
							<form:input path="model" class="span6" type="text" placeholder="1000000" />
						</div>
						</td>
					</tr>
					<tr>
			...
			<table class="table table-bordered table-striped">
				<tbody>
					<tr>
						...
						<div class="input-prepend">
							<span class="add-on"></span>
							<form:input path="gender" class="span6" type="text" />
						</div>
						</td>
					</tr>
					<tr>
						...
						<div class="input-prepend">
							<span class="add-on"></span>
							<form:input path="name" class="span6" type="text" />
						</div>
						</td>
					</tr>
					<tr>
						...
						<div class="input-prepend">
							<span class="add-on"></span>
							<form:input path="phone" class="span6" type="text" />
						</div>
						</td>
					</tr>
					<tr>
						...
						<div class="input-prepend">
							<span class="add-on"></span>
							<form:input path="address" class="span6" type="text" />
						</div>
						</td>
					</tr>
					<tr>
			...
			<table class="table table-bordered table-striped">
				<tbody>
					...
					<tr>
						...
						<div class="input-prepend">
							<span class="add-on"></span>
							<form:input path="account" class="span6" type="text" />
						</div>
						</td>
					</tr>
					<tr>
						...
						<div class="input-prepend">
							<span class="add-on"></span>
							<form:input path="store" class="span6" type="text" />
						</div>
						</td>
					</tr>
				</tbody>
...
$('#id_submit').click(function(){
    ...
    $('#id_customerForm').ajaxSubmit({ 
        url:'updateCustomer.html', //提交给哪个执行
        type:'POST', 
        success: function(){alert("4");} //显示操作提示
        });
    $('#id_salerForm').ajaxSubmit({ 
        url:'updateSaler.html', //提交给哪个执行
        type:'POST', 
